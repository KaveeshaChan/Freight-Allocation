...
import LCLImportPopup from '../Admin_&_MainUSer/PopupForSelectAgent/CompletedIMP-LCL'; // Import the popup component
import FCLExportPopup from '../Admin_&_MainUSer/PopupForSelectAgent/CompletedEXP-FCL'; // Import the popup component
import FCLImportPopup from '../Admin_&_MainUSer/PopupForSelectAgent/CompletedIMP-FCL'; // Import the popup component
...
const Dashboard = ({ children }) => {
  ...
  const fetchCompletedOrders = async () => {
    try {
      ...
      setAvailableOrders(data.quotedOrders || []);
    } catch (error) {
