      ...
      <section className="bg-white rounded-xl shadow-sm border border-gray-100">
        ...
        <div className="p-6">
          <p className="mb-6 text-gray-500 text-sm bg-yellow-50 p-3 rounded-lg border border-yellow-100">
            Note: • Transport and airport handling charges will be specified separately. 
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • Total cost will be calculated accordingly.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { label: 'HAWB ($)', name: 'hawb', type: 'number' },
                ...
                <thead className="bg-gray-50">
                  <tr>
                    {[
                      ...
                      'Air Line', 'Transship Port', 'Transit Time', 
                      'Flight Details', 'Validity'
                    ].map((header) => (
                      <th
                        key={header}
                        className="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider"
