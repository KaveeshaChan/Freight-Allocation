    ...
    <div className="p-6 max-w-7xl mx-auto space-y-8">
      ...
      <section className="bg-white rounded-xl shadow-sm border border-gray-100">
        ...
        <p className="mb-6 text-gray-500 text-sm bg-yellow-50 p-3 rounded-lg border border-yellow-100">
            Note: If the shipment has "Standard free time" or "No free time," enter ‘0’ in the Free Time field.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { label: 'Transit Time', name: 'transitTime', placeholder: 'Days/hours', type: 'number' },
            ...
            <div className="overflow-x-auto rounded-lg border border-gray-200">
              <table className="w-full">
                <thead className="bg-gray-50">
                  <tr>
                    {[
                      'Net Freight (USD)', 'Transshipment Port', 'Transit Time',
                      'Vessel or Flight Details', 'Free Time', 'DO Fee',
                      'Validity Date'
                    ].map((header) => (
                      <th
                        key={header}
