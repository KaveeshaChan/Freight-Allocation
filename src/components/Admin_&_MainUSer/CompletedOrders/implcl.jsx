...
const AirfreightExport = ({ order }) => {
  ...
  return (
    <div>
      ...
      <h1 className="text-2xl font-bold mb-4 text-center text-blue-500">ORDER SUMMARY FOR - ({order.orderNumber}) - IMPORT/LCL</h1>
            ...
            <table className="w-full">
              ...
              <tr>
                ...
                <th className="px-4 py-3 text-center text-xs font-semibold text-gray-500 uppercase tracking-wider cursor-pointer" onClick={() => requestSort('DOFee')}>
                  DO Fee {sortConfig.key === 'DOFee' ? (sortConfig.direction === 'ascending' ? <FiArrowUp /> : <FiArrowDown />) : null}
                </th>
