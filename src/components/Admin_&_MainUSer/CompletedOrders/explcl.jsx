  ...
  return (
    <div>
      <div className="bg-white rounded-lg p-6 max-w-8xl w-full mt">
        <h1 className="text-2xl font-bold mb-4 text-center text-blue-500">ORDER SUMMARY FOR - ({order.orderNumber}) - EXPORT/LCL</h1>
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-200">
                ...
                .map((quote, index) => (
                  ...
                  <td className="px-4 py-3 text-sm overflow-x-auto max-w-[250px] text-left text-gray-700 whitespace-nowrap">{quote.vesselOrFlightDetails}</td>
