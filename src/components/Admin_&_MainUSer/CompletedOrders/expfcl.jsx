  ...
  return (
    <div>
      <div className="bg-white rounded-lg p-6 max-w-8xl w-full mt">
        <h1 className="text-2xl font-bold mb-4 text-center text-blue-500">ORDER SUMMARY FOR - ({order.orderNumber}) - EXPORT/FCL</h1>
              ...
              <tbody className="divide-y divide-gray-200">
                ...
                .map((quote, index) => (
                  <tr key={index} className="cursor-pointer hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 text-sm text-center text-gray-700 whitespace-nowrap">{quote.DTHC}</td>
                    <td className="px-4 py-3 text-sm text-center text-gray-700 whitespace-nowrap">{quote.freeTime}</td>
