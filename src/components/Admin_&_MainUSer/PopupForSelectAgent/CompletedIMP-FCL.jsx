...
const QuoteDetailsPopup = ({ quote, order, onClose, onSelectAgent }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      setIsLoading(true)
      const response = await fetch('http://localhost:5056/api/update/update-preQuotes/import-fcl', {
        method: 'POST',
        headers: {
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 max-w-xl w-full">
              ...
              <div className='flex justify-between flex-wrap gap-4 p-4'>
                ...
                <div className="mb-4">
                  ...
                  <input name='DOFee' type="text" defaultValue={order.DOFee} value={formData.DOFee || ''} onChange={handleChange} className="w-full border rounded px-3 py-2" />
                </div>
                <div className="mb-4">
