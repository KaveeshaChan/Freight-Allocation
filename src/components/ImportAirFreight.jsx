...
<div className="max-w-sm mb-6">
  <div className="flex justify-between items-center">
    <label htmlFor="hs-floating-underline-input-dimensions" className="block text-sm font-medium mb-2 text-black">
      10. Pallet Dimensions (Length * Width * Height)
    </label>
  </div>
  <div className="flex space-x-4">
    <div className="flex-1">
      <input
        ...
        onChange={handleInputChange}
        id="hs-floating-underline-input-length"
        className="py-3 px-4 block w-full border-gray-400 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none bg-white border-gray-400 text-black placeholder-gray-400 focus:ring-black"
        placeholder="Length"
        min="0"
      />
    ...
    <div className="flex-1">
      <input
        ...
        onChange={handleInputChange}
        id="hs-floating-underline-input-width"
        className="py-3 px-4 block w-full border-gray-400 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none bg-white border-gray-400 text-black placeholder-gray-400 focus:ring-black"
        placeholder="Width"
        min="0"
      />
    ...
    <div className="flex-1">
      <input
        ...
        onChange={handleInputChange}
        id="hs-floating-underline-input-height"
        className="py-3 px-4 block w-full border-gray-400 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none bg-white border-gray-400 text-black placeholder-gray-400 focus:ring-black"
        placeholder="Height"
        min="0"
      />
...
<div className="max-w-sm mb-6">
  ...
  />
    ...
    <div className="max-w-sm mb-6">
      <button
        type="submit"  // Use form submission event here
